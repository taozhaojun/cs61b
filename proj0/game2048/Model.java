        ...
        for (int col = 0; col < size; col ++ ) {
            ...
            for (int row = size - 1; row >= 0; row -- ) {
                ...
                if (t != null) {
                    ...
                    int nextPos = 3;
                    while (nextPos >= row) {
                        if (this.board.tile(col, nextPos) == null) {
                            break;
                        }
                        nextPos -- ;
                    }
            ...
            for (int row = 3; row >= 0; row -- ) {
                ...
                Tile nextTile = this.board.tile(col, nextLine);
                ...
                if (nextValue == curTile.value()) {
                    ...
                    this.board.move(col, row, nextTile);
                    ...
                    for (int p = nextLine - 1; p >= 0; p -- ) {
                        Tile tile = this.board.tile(col, p);
                        if (tile == null) {
                            break;
                        }
                        if (p < size) {
                            this.board.move(col, p + 1, tile);
                        }
                    }
                    changed = true;
                }
    ...
    public static boolean atLeastOneMoveExists(Board b) {
        ...
        for (int row = 0; row < size; row++) {
            for (int col = 0; col < size; col++) {
                ...
                if (col > 0 && b.tile(row, col).value() == b.tile(row,col-1).value()) {
                    return true;
                }
                ...
                // Check up and down
                if (row > 0 && b.tile(row, col).value() == b.tile(row - 1, col).value()) {
                    return true;
                }
